...
const WEBHOOK_URL = process.env.NEXT_PUBLIC_CREATOR_WEBHOOK_URL || "https://script.google.com/macros/s/AKfycbxgXyBrtrehtpRPqYZwZ0rR_gO66YkVyq7kbIjUWDFK8_ZSTJv3RIoEeLYPrhItt8Wv/exec";
