...
export const HeroSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Hide hero when scrolled past 85% of hero container
      const heroHeight = windowHeight * 3; // 300vh
      setHeroHidden(scrollY > heroHeight * 0.75);
  ...
  return (
    <div ref={containerRef} className={`hero-container cosmos-style ${heroHidden ? "hero-hidden" : ""}`}>
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">Creative Developer &amp; Digital Craftsman</p>
          <p className="subtitle-line">
            Building experiences at the edge of design &amp; code
          </p>
        </div>
      </div>
      ...
      {/* Empty scroll spacers for camera movement */}
